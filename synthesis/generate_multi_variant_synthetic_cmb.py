...
def process_one_variant(
    ...
    out_img = output_image_dir / f"{stem}_synth502_v{variant_idx:02d}_0000.nii.gz"
    out_mask = output_mask_dir / f"{stem}_synth502_v{variant_idx:02d}.nii.gz"
...
def main():
    ...
    # Synth502 default: reuse each healthy brain 3 times, with fewer lesions per case.
    # This increases negative/background diversity and lowers lesion density vs Synth501.
    parser.add_argument("--num_lesions", type=int, default=3)
    parser.add_argument("--variants_per_brain", type=int, default=3)
    ...
    for image_path in tqdm(image_paths):
        ...
        try:
            for variant_idx in range(args.variants_per_brain):
                process_one_variant(
            ...
            print(f"[OK] {image_path.name} -> {args.variants_per_brain} variants")
...
"""
python add_3d_synth_mcb_batch_502.py \
  --healthy_dir /media/volume1/Luke/Microbleed_nnUNet_Data/Dataset500_SynthDataEfficiency/synth500PoCPick75Var1/imagesHealthy \
  --brainmask_dir /media/volume1/Luke/Microbleed_Data/DataSource/HealthyBrain/canonical_3D/cleaned_brainmask \
  --output_image_dir /media/volume1/Luke/Microbleed_nnUNet_Data/Dataset500_SynthDataEfficiency/synth500PoCPick75Var1/imagesSynth \
  --output_mask_dir /media/volume1/Luke/Microbleed_nnUNet_Data/Dataset500_SynthDataEfficiency/synth500PoCPick75Var1/labelsSynth\
  --num_lesions 5 \
  --variants_per_brain 1 \
  --seed 42
"""